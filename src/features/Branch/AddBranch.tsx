...
import { addBranch } from '@/hooks/Branch';
...
const AddBranchForm: React.FC<AddBranchFormProps> = ({ onClose, onSubmit }) => {
  const { submit, loader } = addBranch();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    let res = await submit(newBranch);
    if (res) {
      onSubmit();
      onClose();
    }
