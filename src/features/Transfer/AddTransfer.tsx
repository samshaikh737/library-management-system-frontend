...
import { useCreateTransfer } from '@/hooks/Transfer';
...
const AddTransferForm: React.FC<AddTransferFormProps> = ({ onClose, onSubmit }) => {
  const { submit, loading } = useCreateTransfer();
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 w-[400px]">
      <h2 className="text-lg font-semibold">Add Transfer</h2>
